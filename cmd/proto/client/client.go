...
import (
	...
	"github.com/tkeel-io/tkeel-template/pkg/base"
)
...
var CmdClient = &cobra.Command{
	...
	Long:  "Generate the proto client code. Example: tkeel-template proto client helloworld.proto",
	Run:   run,
}
...
func run(cmd *cobra.Command, args []string) {
	...
	if err = look("protoc-gen-go", "protoc-gen-go-grpc", "protoc-gen-go-http", "protoc-gen-go-errors", "protoc-gen-validate"); err != nil {
		// update the plugins
		cmd := exec.Command("tkeel-template", "upgrade")
